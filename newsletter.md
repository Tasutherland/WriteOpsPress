    ...
    <div class="newsletter-page-inner">
      ...
      <div style="text-align: left;">
        ...
        <ul style="list-style: disc; padding-left: 1.5rem; color: var(--color-text-muted); font-size: var(--text-sm); line-height: 1.8;">
          ...
          <li>No weekly "just checking in" emails — we write to you when there's something worth saying</li>
        </ul>
        <p style="margin-top: 1.5rem; font-size: var(--text-sm); color: var(--color-text-muted);">
          You can unsubscribe or update your preferences at any time using the link in any email.
          We use <a href="https://www.mailerlite.com" target="_blank" rel="noopener">MailerLite</a> to manage our list.
